...
const Main = () => {
  const { onSent, recentPrompt, showResults, loading, setInput, input } =
    useAiContext();
  return (
    <div className="main">
      <div className="nav">
      ...
      <div className="main-container">
        {!showResults ? (
          <>
            ...
            <div className="cards">
              <Card
                content="Suggest beatiful places to see on an upcomming road trip"
              ...
              />
              <Card
                content="Improve the readability of the code"
        ...
        <div className="main-bottom">
          ...
          <div className="bottom-info">
            Ravyn uses third-party APIs to generate it's response, thus is not
            responsible for any info that proves out to be not true. Use Ravyn
